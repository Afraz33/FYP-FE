...
const UserProfile = () => {
  ...
  const handleSaveChanges = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.put('http://localhost:5000/api/users/user-profile', userData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      <div className="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
        ...
        <div className="mb-4">
          ...
          {isEditing ? (
            ...
            <p className="mt-1 p-2 border rounded-md w-full">{userData.userName}</p>
          )}
        </div>
        <div className="mb-4">
          ...
          {isEditing ? (
            ...
            <p className="mt-1 p-2 border rounded-md w-full">{userData.phoneNo}</p>
          )}
        </div>
        <div className="mb-4">
          ...
          {isEditing ? (
            ...
            <p className="mt-1 p-2 border rounded-md w-full">{userData.password}</p>
          )}
        </div>
        <div className="mb-4">
          ...
          {isEditing ? (
            ...
            <p className="mt-1 p-2 border rounded-md w-full">{userData.email}</p>
          )}
        </div>
