      ...
      <header className="flex h-screen">
        <div className="mt-10 my-auto w-[50%] h-[90%] mx-auto bg-white flex flex-row rounded-lg shadow-2xl shadow-green-950">
          <div className="flex flex-col gap-4 bg-slate-900 w-[40%] justify-center">
            ...
            <hr className="w-[50%] ml-4  border-4 border-green-600 rounded-lg" />
            <div className="pb-10">
            ...
            <div className="pt-10 flex flex-col items-center justify-center w-full max-w-lg">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <button
                  ...
                  className="ml-4 hover:bg-white bg-green-600 text-white hover:text-green-600 font-semibold py-2 px-4 border border-green-600 rounded shadow w-70"
                >
                  Sign Up
                </button>
              </div>
              <button className="mt-4 underline underline-offset-2 ... inline-block mx-auto  hover:text-green-400 text-black  hover:bg-white   hover:text-black  ...">
